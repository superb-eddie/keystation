...
define CARDINAL_BUILD_CMDS
    $(MAKE) $(TARGET_CONFIGURE_OPTS) CROSS_COMPILING=true STATIC_BUILD=true HEADLESS=true -C $(@D)
endef

define CARDINAL_INSTALL_TARGET_CMDS
	$(MAKE) $(TARGET_CONFIGURE_OPTS) CROSS_COMPILING=true STATIC_BUILD=true HEADLESS=true DESTDIR=$(TARGET_DIR)  -C $(@D) install
endef
